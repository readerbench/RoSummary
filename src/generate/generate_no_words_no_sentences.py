...
def summary_no_sentences(configuration_name: str, config_gen: dict, path_model: str, dataset_path_test: str) -> None:
    ...
    for item in tqdm(data):
        sentence_input = f'NoWords: {item["no-words"]} NoSentences: {item["no-sentences"]} Text: {item["text"]} Summary:'
...
if __name__ == '__main__':
    ...
    path_models = {
        'base': f'../../models/no-words-sentences/model/RoGPT2-base-best',
        'medium': f'../../models/no-words-sentences/model/RoGPT2-medium-best',
        'large': f'../../models/no-words-sentences/model/RoGPT2-large-best'
    }
