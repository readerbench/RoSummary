...
def summary_no_sentences(configuration_name: str, config_gen: dict, path_model: str, dataset_path_test: str) -> None:
    ...
    for item in tqdm(data):
        sentence_input = f'NoSentences: {item["no-sentences"]} Text: {item["text"]} Summary:'
        ...
        generation.append({
            "context":  item["text"],
            "original": " ".join(item['summary']),
            "original-list": item['summary'],
...
if __name__ == '__main__':
    ...
    path_models = {
        'base': f'../../models/no-sentences-aleph/model/RoGPT2-base-best',
        'medium': f'../../models/no-sentences-aleph/model/RoGPT2-medium-best',
        'large': f'../../models/no-sentences-aleph/model/RoGPT2-large-best'
    }
