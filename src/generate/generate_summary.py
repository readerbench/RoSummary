...
def summary_generation(configuration_name: str, config_gen: dict, path_model: str, dataset_path_test: str) -> None:
    ...
    for item in tqdm(data):
        ...
        generation.append({
            "context":  f'{item["title"]} {" ".join(item["paragraphs"])}',
            "context-list": [item["title"]] + item["paragraphs"], 
...
if __name__ == '__main__':
    ...
    summary_generation(args.config, configs_gen[args.config] , path_models[args.model], 'test.json')
