...
if __name__ == '__main__':
    ...
    configs_gen = {
        ...
        'sample-top-k': {'top_k': 25, 'temperature': 0.65, 'do_sample': True},
        'sample-top-p': {'top_k': 25, 'top_p': 0.94, 'do_sample': True},
    }
    path_models = {
        'base': f'../../models/no-words-overlap-combine/model/RoGPT2-base-best',
        'medium': f'../../models/no-words-overlap-combine/model/RoGPT2-medium-best',
        'large': f'../../models/no-words-overlap-combine/model/RoGPT2-large-best'
    }
