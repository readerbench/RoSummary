...
def summary_ration_tokens(configuration_name: str, config_gen: dict, path_model: str, dataset_path_test: str) -> None:
    ...
    for item in tqdm(data):
        sentence_input = f'RatioTokens: {item["ration-tokens"]} Text: {item["text"]} Summary:'
        ...
        generation.append({
            ...
            "ration-tokens": item["ration-tokens"]
        })
...
if __name__ == '__main__':
    ...
    path_models = {
        'base': f'../../models/ration_tokens/model/RoGPT2-base-best',
        'medium': f'../../models/ration_tokens/model/RoGPT2-medium-best',
        'large': f'../../models/ration_tokens/model/RoGPT2-large-best'
    }

    summary_ration_tokens(args.config, configs_gen[args.config] , path_models[args.model], 'test.json')
