...
def summary_no_words(configuration_name: str, config_gen: dict, path_model: str, dataset_path_test: str) -> None:
    ...
    for item in tqdm(data):
        sentence_input = f'NoWords: {item["no-words"]} Text: {item["text"]} Summary:'
...
if __name__ == '__main__':
    ...
    path_models = {
        'base': f'../../models/no-words/model/RoGPT2-base-best',
        'medium': f'../../models/no-words/model/RoGPT2-medium-best',
        'large': f'../../models/no-words/model/RoGPT2-large-best'
    }

    summary_no_words(args.config, configs_gen[args.config] , path_models[args.model], 'test.json')
